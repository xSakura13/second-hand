...
function theme_register_nav_menu(){
    ...
    register_nav_menu('season', 'Меню категорій');
}


function style_theme(){
    wp_enqueue_style('bootstrap-style', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css' , [], '5.1.3');
    wp_enqueue_style('slick', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css');
    wp_enqueue_style('animate', get_template_directory_uri() . '/assets/css/animate.css');
    wp_enqueue_style('style', get_template_directory_uri() . '/assets/css/style.css'  , '', '1.1.1' );
}
function scripts_theme(){
    ...
    wp_enqueue_script('myscript', get_template_directory_uri() . '/assets/js/js.js' , '', '1.0.8');
}
