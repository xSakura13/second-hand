...
$gallery = get_field('gallary', $post->ID);
        ...
        <div class="title">
            <div class="item_container">
                <div class="title_products">
                    ...
                    <?php if(!empty(wp_get_post_terms($post->ID, 'products-category'))) { ?>
                        <span>
                           <?php print_r( wp_get_post_terms($post->ID, 'products-category')[0]->name); ?>
                        </span>
                    <?php } ?>
                </div>
            </div>
                ...
                <div class="content_wrapper">
                    <div class="card_left">
                        ...
                        <?php if($video) { ;?>
                            <div class="video_logo">
                                <iframe src="https://www.youtube.com/embed/<?php echo $video;?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="card_right">
                        ...
                        <div class="info_cost">
                            <div class="price">
                                <p class="title">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/images/price.png" alt="price"> Вартість
                                </p>
                                <div class="numbers">
                                    <?php echo get_field('price', $post->ID); ?>
                                    <img src="<?php echo get_template_directory_uri();?>/assets/images/dollar.png" alt="" srcset="">
                                </div>
                            </div>
                            <div class="weight">
                                <p class="title">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/images/weight.png" alt="weight"> Вага
                                </p>
                                <div class="numbers">
                                    <?php echo get_field('weight', $post->ID); ?>
                                    <span>кг</span>
                                </div>
                            </div>
                            <div class="cost">
                                <p class="title">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/images/price2.png" alt="price">Собівартість
                                </p>
                                <div class="numbers">
                                    ~<?php echo get_field('cost_price', $post->ID); ?>
                                    <img src="<?php echo get_template_directory_uri();?>/assets/images/grn.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="mini_info">
                            <img src="<?php echo get_template_directory_uri();?>/assets/images/camera.png" alt="camera"> Усі фото є оригінальними
                        </div>
                        <?php if($video) { ;?>
                            <div class="video_logo">
                                <iframe src="https://www.youtube.com/embed/<?php echo $video;?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
